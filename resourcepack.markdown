...
We have a server resource pack which is used for various things, including the slime bucket, custom discs, the spooncraft spoon and emojis in chat.
...
**[Download (Java Edition)]({{ site.url }}{{ site.baseurl }}/files/resource_packs/MumboSRP_20241001_Java.zip)**
{: .notice--success}